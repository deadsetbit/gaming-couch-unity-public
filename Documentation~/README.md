...
- [The game script](../README.md#the-game-script)
- [Players and colors](../README.md#players-and-colors) and [Player inputs](../README.md#player-inputs)
...
- [API documentation](https://deadsetbit.github.io/gaming-couch-unity-public/0.1.0-alpha.11/api)
